...
const courseData = [
  ...
  { id: 5, name: 'Artificial Intelligence', image: '/images/course/Artificial.jpeg', slug: 'ai', rating: 4.8, description: 'Explore the future with AI and machine learning.', duration: '6 Months' },
